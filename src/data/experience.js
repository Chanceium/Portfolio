export const experienceSection = {
  subtitle: "My professional journey and experiences",
};
export const experience = [
  ...
  },
  {
    ...
    description: "Conducted comprehensive audits and documentation for four data centers, encompassing all devices, Ethernet/cabling standards, and inputs into switches, routers, firewalls, servers, and other infrastructure devices.",
    highlights: [
      "Utilized Nautobot, a source of truth documentation application, to maintain accurate and up-to-date records",
      "Tested and wiped over 200 hardware devices from various manufacturers including Juniper, Cisco, Adtran, Ubiquiti, and Mikrotik",
      "Followed MOP/SOP documentation to service Juniper and Mikrotik devices for businesses",
      "Created comprehensive documentation for Nautobot, contributing to the knowledge base",
      "Built data center racks and ran power and Ethernet/fiber to data centers"
    ],
    logo: "https://www.execulink.ca/wp-content/uploads/2023/01/logo.svg",
  ...
  {
    company: "Execulink Telecom",
    position: "Geographic Information Systems Data Technician",
    location: "Woodstock, Ontario",
    duration: "Jan 2023 - May 2023",
    description: "As a GIS Data Technician, I operated across Southern Ontario, leveraging Trimble devices to accurately locate coordinates for network infrastructure.",
    highlights: [
      "Utilized CAD and ArcGIS to pin GPS coordinates, providing precise locations of infrastructure",
      "Contributed to obtaining government approval and maintaining comprehensive documentation by accurately mapping infrastructure"
    ],
    logo: "https://www.execulink.ca/wp-content/uploads/2023/01/logo.svg",
